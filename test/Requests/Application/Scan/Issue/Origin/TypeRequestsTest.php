...
namespace RIPS\Test\Requests\Application\Scan\Issue\Origin;
...
class TypeRequestsTest extends TestCase
{
    ...
    public function getAll()
    {
        ...
        $this->assertEquals('/applications/scans/issues/origins/types', $request->getUri()->getPath());
    ...
    public function getById()
    {
        ...
        $this->assertEquals('GET', $request->getMethod());
        $this->assertEquals('/applications/scans/issues/origins/types/1', $request->getUri()->getPath());
        $this->assertEquals('value', $response->getDecodedData()->key);
    }
}
