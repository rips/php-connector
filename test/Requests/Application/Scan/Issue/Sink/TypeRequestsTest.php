...
namespace RIPS\Test\Requests\Application\Scan\Issue\Sink;
...
class TypeRequestsTest extends TestCase
{
    ...
    public function getAll()
    {
        ...
        $this->assertEquals('/applications/scans/issues/sinks/types', $request->getUri()->getPath());
    ...
    public function getById()
    {
        ...
        $this->assertEquals('GET', $request->getMethod());
        $this->assertEquals('/applications/scans/issues/sinks/types/1', $request->getUri()->getPath());
        $this->assertEquals('value', $response->key);
    }
}
